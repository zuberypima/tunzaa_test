...
import 'package:tunzaatest/features/home/view/search_view.dart';
...
// Search Widget 
  ElasticInDown _searchProducts(BuildContext context, HomeViewModel viewModel) =>
      ElasticInDown(
        duration: context.durationSlow,
          ...
          child: Padding(
            ...
            child: Wrap(
              ...
              children: [
                ...
                Subtitle1Text(
                  data: 'Your basket is Cart empty.',
                  context: context,
                  color: context.primaryColor,
                ),
              ],
